...
namespace CLI::detail
{
    ...
    template <typename F> [[nodiscard]] scope_guard_t<F> scope_guard(F &&closure)
    {
...
export namespace CLI
{
    ...
    std::string narrow(const wchar_t *str, std::size_t str_size)
    {
    ...
    std::wstring widen(const char *str, std::size_t str_size)
    {
