...
export namespace CLI
{
    ...
    template <typename CRTP> class OptionBase
    {
        ...
        public:
            ...
            [[nodiscard]] bool get_disable_flag_override() const
            {
                return disable_flag_override_;
            }
            [[nodiscard]] char get_delimiter() const
            {
                return delimiter_;
            }
            [[nodiscard]] bool get_always_capture_default() const
            {
                return always_capture_default_;
            }
            [[nodiscard]] MultiOptionPolicy get_multi_option_policy() const
            {
                return multi_option_policy_;
            }
            [[nodiscard]] CallbackPriority get_callback_priority() const
            {
    ...
    class Option : public OptionBase<Option>
    {
        ...
        public:
            ...
            [[nodiscard]] bool get_allow_extra_args() const
            {
            ...
            [[nodiscard]] bool get_trigger_on_parse() const
            {
            ...
            [[nodiscard]] bool get_force_callback() const
            {
            ...
            [[nodiscard]] bool get_run_callback_for_default() const
            {
            ...
            [[nodiscard]] int get_type_size() const
            {
                return type_size_min_;
            }
            [[nodiscard]] int get_type_size_min() const
            {
                return type_size_min_;
            }
            [[nodiscard]] int get_type_size_max() const
            {
                return type_size_max_;
            }
            [[nodiscard]] bool get_inject_separator() const
            {
                return inject_separator_;
            }
            [[nodiscard]] std::string get_envname() const
            {
                return envname_;
            }
            [[nodiscard]] std::set<Option *> get_needs() const
            {
                return needs_;
            }
            [[nodiscard]] std::set<Option *> get_excludes() const
            {
                return excludes_;
            }
            [[nodiscard]] std::string get_default_str() const
            {
                return default_str_;
            }
            [[nodiscard]] callback_t get_callback() const
            {
                return callback_;
            }
            [[nodiscard]] const std::vector<std::string> &get_lnames() const
            {
                return lnames_;
            }
            [[nodiscard]] const std::vector<std::string> &get_snames() const
            {
                return snames_;
            }
            [[nodiscard]] const std::vector<std::string> &get_fnames() const
            {
                return fnames_;
            }
            ...
            [[nodiscard]] int get_expected() const
            {
                return expected_min_;
            }
            [[nodiscard]] int get_expected_min() const
            {
                return expected_min_;
            }
            [[nodiscard]] int get_expected_max() const
            {
                return expected_max_;
            }
            [[nodiscard]] int get_items_expected_min() const
            {
            ...
            [[nodiscard]] int get_items_expected() const
            {
                return get_items_expected_min();
            }
            [[nodiscard]] bool get_positional() const
            {
                return !pname_.empty();
            }
            [[nodiscard]] bool nonpositional() const
            {
            ...
            [[nodiscard]] const std::string &get_option_text() const
            {
                return option_text_;
            }
            ...
            [[nodiscard]] std::string get_name(bool positional = false,
            ...
            [[nodiscard]] const results_t &results() const
            {
                return results_;
            }
            ...
            [[nodiscard]] bool get_callback_run() const
            {
