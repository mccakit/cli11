...
class ConstructionError : public Error {
  ...
  public:
    ConstructionError(std::string msg, ExitCodes exit_code) : Error("ConstructionError", std::move(msg), exit_code) {}
...
class BadNameString : public ConstructionError {
  ...
  public:
    ...
    BadNameString(std::string msg, int exit_code) : ConstructionError("BadNameString", std::move(msg), exit_code) {}
...
class ConversionError : public ParseError {
  ...
  public:
    ConversionError(std::string msg, ExitCodes exit_code) : ParseError("ConversionError", std::move(msg), exit_code) {}
    ConversionError(std::string msg, int exit_code) : ParseError("ConversionError", std::move(msg), exit_code) {}
    explicit ConversionError(std::string msg) : ConversionError("ConversionError", msg, ExitCodes::ConversionError) {}
...
class ValidationError : public ParseError {
  ...
  public:
    ValidationError(std::string msg, ExitCodes exit_code) : ParseError("ValidationError", std::move(msg), exit_code) {}
    ValidationError(std::string msg, int exit_code) : ParseError("ValidationError", std::move(msg), exit_code) {}
    explicit ValidationError(std::string msg) : ValidationError("ValidationError", msg, ExitCodes::ValidationError) {}
